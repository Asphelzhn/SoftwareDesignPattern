...
public class StrategyGUI extends JFrame {
  ...
  public static final String Bidirectional = "Bidirectional bubble Sort";
  ...
  private void setUpChoicePanel() {
	  ...
	  cmbAlgorithm.addItem(Bidirectional);
   ...
   class ButtonListener implements ActionListener {
      public void actionPerformed(ActionEvent ae) {
		...
		if (ae.getActionCommand().equals(SORT)) {
            ...
            if (type.equals(Bidirectional)) {
                sa = new BidirBubbleSort();
                System.out.println("Bidirectional sort");
            }
